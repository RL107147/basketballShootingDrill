...
class TableViewController11: UITableViewController {
    
    let defaults = UserDefaults.standard
    var assignments: [String] = [] {
        didSet {
            defaults.set(assignments, forKey: "Assignment11")
        }
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        if let savedAssignments = defaults.object(forKey: "Assignment11") as? [String]{
