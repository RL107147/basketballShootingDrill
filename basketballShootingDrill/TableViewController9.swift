...
class TableViewController9: UITableViewController {
    
    let defaults = UserDefaults.standard
    var assignments: [String] = [] {
        didSet {
            defaults.set(assignments, forKey: "Assignment9")
        }
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        if let savedAssignments = defaults.object(forKey: "Assignment9") as? [String]{
