...
class TableViewController12: UITableViewController {
    
    let defaults = UserDefaults.standard
    var assignments: [String] = [] {
        didSet {
            defaults.set(assignments, forKey: "Assignment12")
        }
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        if let savedAssignments = defaults.object(forKey: "Assignment12") as? [String]{
