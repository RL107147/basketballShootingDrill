...
class TableViewController10: UITableViewController {
    
    let defaults = UserDefaults.standard
    var assignments: [String] = [] {
        didSet {
            defaults.set(assignments, forKey: "Assignment10")
        }
    }
    
    override func viewDidLoad() {
        super.viewDidLoad()
        if let savedAssignments = defaults.object(forKey: "Assignment10") as? [String]{
